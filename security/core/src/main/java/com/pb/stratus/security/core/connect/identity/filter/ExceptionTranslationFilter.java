 ...
 * <p>
 * If an {@link AccessDeniedException} is detected, the filter will delegate to the {@link org.springframework.security.web.access.AccessDeniedHandler}.
...
//        Assert.notNull(portResolver, "portResolver must be specified");
    ...
    private void handleException(HttpServletRequest request, HttpServletResponse response, FilterChain chain,
        ...
        if (exception instanceof AuthenticationException) {
            ...
            //conn-18711
            // this points handles cases for redirection to login screen in case authentication object is null;
            //Authentication object is null if its are a request without username and password or if its
            //a timeout.We may skip this exception in the logs.
          /*  if (logger.isDebugEnabled()) {
