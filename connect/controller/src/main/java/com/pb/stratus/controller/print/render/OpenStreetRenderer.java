...
/**
 * Facilitates rendering of Open Street Maps.
 * 
 * @author sa021sh
 * 
 */
public class OpenStreetRenderer implements LayerRenderer {
	/**
	...
	public OpenStreetRenderer(TileCompositor tileCompositor,
