 ...
 */
public class RenderMapParams implements MapRequestParams, Cloneable
{
    // Properties
    ...
    public void setMapLayers(List<String> mapLayers) {

        if(null == mapLayers || mapLayers.isEmpty())
        {
            throw new IllegalRequestException("map Layers cannot be empty");
        }
