...
public class PerimeterRequestBuilder extends AbstractMeasuringBuilder{

    public PerimeterRequestBuilder()
    {
        super();
    }
    @Override
    public void setGeometry(Geometry geometry) {
        Preconditions.checkNotNull(geometry, "geometry cannot be null");
                ((PerimeterRequest) this.geometryServiceRequest).setGeometry(geometry);
    }
    ...
    {
        return ((PerimeterRequest) this.geometryServiceRequest).getGeometry();
    }
    ...
    public void setLengthUnit(DistanceUnit lengthUnit) {
        ...
        ((PerimeterRequest)this.geometryServiceRequest).setLengthUnit(lengthUnit);
    }
    ...
    {
        return ((PerimeterRequest)this.geometryServiceRequest).getLengthUnit();
    }
    ...
    public void setComputationType(ComputationType computationType)
    {
        ...
        ((PerimeterRequest)this.geometryServiceRequest).setComputationType(computationType);
    }
    ...
    {
        return ((PerimeterRequest)this.geometryServiceRequest).getComputationType();
    }

    @Override
    protected void createGeometryServiceRequest() {
        this.geometryServiceRequest = new PerimeterRequest();
    }
}
