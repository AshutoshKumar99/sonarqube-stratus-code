...
import com.pb.stratus.controller.featuresearch.FilteredQuery;
...
/**
 * SearchBYSQL queryAction.
 *
 * @author ar009sh
 */
public class FeatureSearchByQueryAction extends FeatureSearchAction {

    private FileSystemConfigReader reader = null;
    private AuthorizationUtils authorizationUtils;

    private static final Logger log =
            LogManager.getLogger(FeatureSearchByQueryAction.class);

    public FeatureSearchByQueryAction(FeatureService featureService,
