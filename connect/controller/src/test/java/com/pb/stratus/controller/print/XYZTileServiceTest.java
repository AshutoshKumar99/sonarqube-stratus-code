...
public class XYZTileServiceTest {

    private static final String LAYER_NAME = "XYZTest";
    ...
    @Test
    public void getTileSetForFullMap_ZeroBased() throws IOException, ServletException
    {
        ...
        LayerBean mockLayer = new LayerBean(LAYER_NAME,"XYZ-Tile-Service",mockUrlArray,true,"png");
    ...
    @Test
    public void getTileSetForSubsetOfMap_ZeroBased() throws IOException, ServletException
    {
    ...
    @Test
    public void getTileSetForFullMap_OneBased() throws IOException, ServletException
    {
        boundingBox = new BoundingBox(MAX_NORTH_BOUND,MAX_SOUTH_BOUND,MAX_WEST_BOUND,MAX_EAST_BOUND,SRS);
        when(mockLayerRenderParams.getBoundingBox()).thenReturn(boundingBox);
        LayerBean mockLayer = new LayerBean(LAYER_NAME,"XYZ-Tile-Service",mockUrlArray,false,"png");
        when(mockLayerRenderParams.getLayer()).thenReturn(mockLayer);
    ...
    @Test
    public void getTileSetForSubsetOfMap_OneBased() throws IOException, ServletException
    {
        boundingBox = new BoundingBox(MAX_NORTH_BOUND/2,MAX_SOUTH_BOUND/2,MAX_WEST_BOUND/2,MAX_EAST_BOUND/2,SRS);
        when(mockLayerRenderParams.getBoundingBox()).thenReturn(boundingBox);
        LayerBean mockLayer = new LayerBean(LAYER_NAME,"XYZ-Tile-Service",mockUrlArray,false,"png");
