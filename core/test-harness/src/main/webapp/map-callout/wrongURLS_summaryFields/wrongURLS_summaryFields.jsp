...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en">
    <head>
        ...
        <script type="text/javascript">
            ...
            {
                map = new stratus.MapControl({configFile: "wrongURLS_summaryFields.xml"}, "mapControl");
    ...
    <body>
      <p>
        <center>This page tests when we use wrong fields in summary fields (if we use street in image column and location in link column). When you click on the map you can see the callout parameters.</center>
    </p><br/>
