...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en">
    <head>
        ...
        <script type="text/javascript">
            ...
            {
                map = new stratus.MapControl({configFile: "missingSummaryFields.xml"}, "mapControl");
    ...
    <body>
     <p>
        <center>This page tests missing summary fields. Once you click on the map you can see the callout parameters.</center>
    </p><br/>
