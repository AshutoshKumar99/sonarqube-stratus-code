...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en">
    <head>
        ...
        <script type="text/javascript">
            ...
            {
                map = new stratus.MapControl({configFile: "noSummaryFields.xml"}, "mapControl");
    ...
    <body>
<p>
        <center>This page tests if we do not use the summary fields in the configuration file. When you click on the map you can see the callout parameters.</center>
    </p><br/>
