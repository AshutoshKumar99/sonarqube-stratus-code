...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en">
    <head>
        ...
        <script type="text/javascript">
            ...
            {
                map = new stratus.MapControl({configFile: "incorrectSummaryFields.xml"}, "mapControl");
    ...
    <body>
     <p>
        <center>This page tests the incorrect summary fields for examples if we use wrong title in title column and wrong image in image column. Once you click on the map you can see the callout parameters.</center>
    </p><br/>
