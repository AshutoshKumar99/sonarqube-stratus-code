...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en">
    <head>
        ...
        <script type="text/javascript">
            ...
            {
                map = new stratus.MapControl({configFile: "NorthSomerset.xml"}, "mapControl");
    ...
    <body>
     <p>
        <center>This page tests valid summary Fields for North Somerset Transport data. When you click on the map you can see the callout parameters.</center>
    </p><br/>
