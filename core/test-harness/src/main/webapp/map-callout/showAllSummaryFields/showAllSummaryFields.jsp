...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en">
    <head>
        ...
        <script type="text/javascript">
            ...
            {
                map = new stratus.MapControl({configFile: "showAllSummaryFields.xml"}, "mapControl");
    ...
    <body>
    <p>
        <center>This page tests show all the summary Fields whether we define the summary fields or not . When you click on the map you can see the callout parameters.</center>
    </p><br/>
